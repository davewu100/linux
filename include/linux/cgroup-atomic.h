...
/* Zero-copy cache access API (eliminates memcpy for batch reads) */
...
static inline const u64 *css_atomic_cache_begin_read_stats(
				struct mem_cgroup *memcg, unsigned int *seq)
{
	return NULL;
}
static inline bool css_atomic_cache_end_read_stats(struct mem_cgroup *memcg,
						     unsigned int seq)
{
	return false;
}
static inline const unsigned long *css_atomic_cache_begin_read_events(
				struct mem_cgroup *memcg, unsigned int *seq)
{
	return NULL;
}
static inline bool css_atomic_cache_end_read_events(struct mem_cgroup *memcg,
						      unsigned int seq)
{
	return false;
}
