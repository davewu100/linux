...
SYSCALL_DEFINE2(swapon, const char __user *, specialfile, int, swap_flags)
{
	...
	/*
	 * Probe whether the backing device can store precompressed data as-is
	 * (see REQ_COMPRESSED).  Only meaningful for the synchronous bdev path,
	 * which is the one that carries the hint.
	 */
