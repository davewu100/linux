...
static int __init zram_init(void)
{
	...
	/*
	 * The CPUHP_ZCOMP_PREPARE state is now registered by lib/zcomp's
	 * core_initcall, shared by all zcomp users, so zram no longer sets it
	 * up (or tears it down) itself.
	 */
